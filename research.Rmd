...
**[Equity of COVID-19-induced job loss duration](files/job_loss_duration_equity.pdf)**\
...
**The evolving effects of electoral gender quotas over a decade, (with Roshani Bulkunde)**\
*How much do past gender quotas affect present outcomes?*
<details>
```{r echo=FALSE,out.width='100%', out.extra='style="float:center; padding:10px"'}
knitr::include_graphics("graphs/evolving_website_graph.png")
```
</details>
