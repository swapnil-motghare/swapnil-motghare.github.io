...
**Motghare, S. (2023). [Contemporaneous and Lasting Effects of Electoral Gender Quotas.](https://www.sciencedirect.com/science/article/abs/pii/S0305750X23001109) _World Development_**\
...
**Motghare, S. and [V. V. Kamble](https://vikrant-v-kamble.github.io/) (2026). [Intertemporal Elasticity of Labor Supply: Evidence from New York City Taxicab Drivers Using a New Instrument.](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=7288558)**\
...
**Motghare, S. (2022). Unemployment insurance generosity and labor supply - Evidence from the COVID-19 recession**\
...
#| echo: false
#| out-width: 100%
#| out-extra: 'style="float:center; padding:10px"'
knitr::include_graphics("graphs/ui_labor_supply_website_graph.png")
```
</details>

<details>
  <summary>[Poster for AEA 2023 Annual Meeting](files/aea_poster.pdf)</summary>
</details>

**Motghare, S. (2022). Equity of COVID-19-induced job loss duration**\
*How does the duration of unemployment during the COVID-19 pandemic vary by gender, race, and ethnicity?*

<details>
  <summary>Abstract</summary>
I study COVID-19-induced job losses using administrative data on the universe of Unemployment Insurance claims for the state of Indiana. I show that during the pandemic, women and Blacks not only lost more jobs but also stayed unemployed longer. The differences in job loss duration for Black-whites are much bigger than men-women and a smaller portion of the gap is explained by observable characteristics. The differences in duration emerge due to later ending of the unemployment spell rather than early beginning consistent with the last hired but not with the first firing of Blacks during weak economic periods. The adverse effects of the COVID-19 recession for women and Blacks were thus worse than implied by only the job losses.
</details>

<!-- ## Research in progress
**Evaluating Right-to-Work laws using Census data,** (with Ye Ji Kee and [Yong Suk Lee](https://keough.nd.edu/profile/yong-suk-lee/))\
*How do RTW laws affect the labor market, automation technology adoption, and firm productivity?*
-->

## Policy reports

**[Tracking AI-Related Job Loss Using Unemployment Insurance Claims Data in California](https://capolicylab.org/wp-content/uploads/2026/06/Tracking-AI-Related-Job-Loss-Using-Unemployment-Insurance-Claims-Data-in-California.pdf),** (with Ben Hyman, Till von Wachter, Diana Herrera, Roozbeh Moghadam, Jacob Morris, Swapnil Motghare and Kara Segal)

**[Inventors and Unemployment Insurance: Understanding the Safety Net for Innovators](https://capolicylab.org/wp-content/uploads/2026/03/Inventors-and-Unemployment-Insurance.pdf),** (with Alex Bell, Sreeraahul Kancherla, Roozbeh Moghadam, and Till von Wachter)

**[Impact Evaluation: City of South Bend Commuters Trust Program](files/ct_report.pdf),** (with [Danice Brown Guzmán](https://pulte.nd.edu/people/staff/danice-brown-guzman/))

**[Impact Evaluation: Community Nonprofit Partner Program - South Bend's Mayors Challenge](files/cnpp_report.pdf),** (with [Danice Brown Guzmán](https://pulte.nd.edu/people/staff/danice-brown-guzman/))
